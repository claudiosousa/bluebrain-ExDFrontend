...
(function() {
  ...
  angular.module('exdFrontendApp').directive('resizeable', [
    '$window',
    '$document',
    function($window, $document) {
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          scope.$watch(
            function() {
              return element.attr('resizeable') === 'true';
            },
            newValue => {
              if (newValue === true) {
          ...
          function calculateNewSize(size) {
            var maxWidth =
              $window.innerWidth - element.offset().left - SAFETY_PAD;
            var maxHeight =
              $window.innerHeight - element.offset().top - SAFETY_PAD;
            ...
            if (keepAspectRatio === null) {
              ...
              newHeight = Math.min(
                size.initHeight + size.mouseOffsetY,
                maxHeight
              );
            } else {
          ...
          function mousemove(event) {
            ...
            element.css(
              'height',
              newSize.height / window.innerHeight * FRACTION_TO_PERCENTAGE + '%'
            );
            element.css(
              'width',
              newSize.width / window.innerWidth * FRACTION_TO_PERCENTAGE + '%'
            );
