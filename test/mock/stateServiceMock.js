(function() {
  ...
  angular.module('stateServiceMock', []).service('stateService', function() {
    var getCurrentStateSpy = jasmine.createSpy('getCurrentState');
    var setCurrentStateSpy = jasmine.createSpy('setCurrentState');
    var ensureStateBeforeExecutingSpy = jasmine
      .createSpy('ensureStateBeforeExecuting')
      .and.callFake(function(STATE, fn) {
        fn();
      });
    ...
    setCurrentStateSpy.and.callFake(function(s) {
      ...
      return {
        ...
        catch: setCatchSpy.and.callFake(function(f) {
          f();
        })
      };
    });
    ...
    this.startListeningForStatusInformation = jasmine.createSpy(
      'startListeningForStatusInformation'
    );
    this.stopListeningForStatusInformation = jasmine.createSpy(
      'stopListeningForStatusInformation'
    );
