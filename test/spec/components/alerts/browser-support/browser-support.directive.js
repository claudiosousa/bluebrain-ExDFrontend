(function() {
    ...
    describe('Directive: browser-support-alert', function() {
        ...
        var scope, browserSupport,
            $window, $timeout;

        beforeEach(inject(function($rootScope, $compile, _browserSupport_, _$window_, _$timeout_) {
            ...
            var element = $compile('<browser-support-alert></browser-support-alert>')($rootScope);
            $rootScope.$digest();
            scope = element.scope();
        }));
