...
describe('Services: video-stream-service', function() {
  ...
  it('should throw an exception if server config misses \'videoStreaming\'', function(done) {
