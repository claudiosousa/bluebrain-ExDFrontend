...
describe('Directive: environment settings colors', function ()
{
  ...
  beforeEach(module(function ($provide)
  {
    ...
    gz3dMock.scene.composerSettings.rgbCurve = { 'red': [], 'green': [], 'blue': [] };    // Color correction, disabled by default
    ...
    gz3dMock.scene.applyComposerSettings = function (updateCurve) { }; // jshint ignore:line
    ...
    $compile)
  {
    ...
    element = $compile('<environment-settings-colors></environment-settings-colors>')($rootScope);
    $rootScope.$digest();
  }));
