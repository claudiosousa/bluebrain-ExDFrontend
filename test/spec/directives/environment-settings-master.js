...
describe('Directive: environment settings master', function ()
{
  ...
  beforeEach(module(function ($provide)
  {
    ...
    gz3dMock = { 'scene': { 'composer': { 'currentMasterSettings': GZ3D.MASTER_QUALITY_BEST } } };
    gz3dMock.scene.setMasterSettings = function(n){this.composer.currentMasterSettings=n;};
    ...
    $compile)
  {
    ...
    element = $compile('<environment-settings-master></environment-settings-master>')($rootScope);
    $rootScope.$digest();
  }));
  ...
  it('should update values to scene', function ()
  {
    ...
    expect(gz3dMock.scene.composer.currentMasterSettings).toBe(GZ3D.MASTER_QUALITY_MINIMAL);
  });
