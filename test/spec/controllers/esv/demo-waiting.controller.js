...
describe('Controller: demo-waiting', function ()
{
    ...
    var $rootScope, $compile, bbpConfig, scope,  controller,
        $httpBackend, STATE, $timeout, location, demoWaitCtrl;
    ...
    beforeEach(inject(function ($controller, _$rootScope_, _$compile_, _bbpConfig_, _$httpBackend_, _STATE_, _$timeout_,_$window_,_$location_)
    {
